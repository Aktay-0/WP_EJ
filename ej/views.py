...
def student_schedule(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/student.html/schedule.html/schedule.html', {'usr': usr})
    else:
        return redirect('index') 
...
def student_info(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/student.html/info.html/info.html', {'usr': usr})
    else:
        return redirect('index')
...
def student_marks(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/student.html/marks.html/marks.html', {'usr': usr})
    else:
        return redirect('index') 
###########################--Student--#############################
...
def admin_info(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/info.html/info.html', {'usr': usr})
    else:
        return redirect('index') 

def admin_schedule_edit(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/schedule_edit.html/schedule_edit.html', {'usr': usr})
    else:
        return redirect('index') 

def admin_replacement_edit(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/replacement_edit.html/replacement_edit.html', {'usr': usr})
    else:
        return redirect('index') 

def admin_log_edit(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/log_edit.html/log_edit.html', {'usr': usr})
    else:
        return redirect('index') 

def admin_module_edit(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/module_edit.html/module_edit.html', {'usr': usr})
    else:
        return redirect('index') 

def admin_load_edit(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/load_edit.html/load_edit.html', {'usr': usr})
    else:
        return redirect('index') 
...
def admin_group_edit(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/group_edit.html/group_edit.html', {'usr': usr})
    else:
        return redirect('index')
...
def admin_statistics(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/statistics.html/statistics.html', {'usr': usr})
    else:
        return redirect('index')

def admin_students_edit(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/student_edit.html/student_edit.html', {'usr': usr})
    else:
        return redirect('index')
...
def admin_teacher_edit(request):
    if request.session.get(request.META['REMOTE_ADDR'], '') != '':
        usr = Users_login.objects.get(login = request.session[request.META['REMOTE_ADDR']])
        return render(request, 'ej/admin.html/teacher_edit.html/teacher_edit.html', {'usr': usr})
    else:
        return redirect('index')
###########################--Admin--###############################
